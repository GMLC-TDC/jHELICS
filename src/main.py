...
from bindingGenerators.javaBindingGeneratorJNA import JavaBindingGenerator


def main(bindingsRootDir: str, helicsHeaders: List[str]) -> None:
    """
    Main function for building JAVA language bindings of the HELICS C library
    """
    generator = JavaBindingGenerator(bindingsRootDir, helicsHeaders)
...
if __name__ == '__main__':
    ...
    userInputParser.add_argument("bindingsRootDir", nargs="?", default=os.getcwd(),
        help="location to generate java language bindings.")
